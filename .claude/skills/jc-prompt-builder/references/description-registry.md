...
> 2026-08-18 타깃 동기(리멤버 전환): mice-estimate description(v3.0.0) 미러 + 버전 헤딩 갱신(jc-design-system v1.4.0·jc-theme-factory v1.1.0). 전체 재생성(run-of-show·aftermath·cinematic §2 행 편입, 26→28종 정합)은 별도 사이클로 이월(두 미러 정합 백로그).
