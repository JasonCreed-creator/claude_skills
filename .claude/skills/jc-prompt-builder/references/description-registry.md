...
> 생성: 2026-07-12 · 상태: 확정본
> 기준: CP3 인테이크 반영 — 신규 2종(jc-brand-discovery·jc-workspace-ops) 편입 + jc-orchestrator 스냅숏 최초 포함
> 소스: `G:\내 드라이브\Claude Workspace\Skills\library` (25종)
