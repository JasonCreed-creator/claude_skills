...
| Drive 폴더·파일 운영·정리 | jc-workspace-ops | '드라이브/폴더/파일 정리'·'폴더 구조/위계'·'공유 권한 점검'·'중복/최신본'·'트래커/체크리스트' — 산출물의 *저장·배치·점검·청소* 운영 층(생성이 아님) | 표준 폴더 트리·배치·권한 점검 결과 + 시트 트래커 (권한변경·삭제·이동 등 고위험 조작은 안내만) |
