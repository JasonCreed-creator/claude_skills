...
mice-dashboard v1 은 4종 자체 컬러 팔레트(`#1a1a2e`, `#2563eb`, `#6366f1`, `#1e3a5f` 등)를 직접 사용 → 디자인 일관성 깨짐. v2 는 각 팔레트를 **jc 시맨틱 토큰**으로 매핑하여 클라이언트 오버레이 토글 가능 구조 확보.
...
|---|---|---|---|---|
| 페이지 배경 | `#1a1a2e` | `COLOR_BG_PAGE` | `#ffffff` | `#0f172a` |
| 카드 배경 | `#16213e` | `COLOR_BG_CARD` | `#f8fafc` | `#1e293b` |
| 액센트 | `#0f3460` | `COLOR_BRAND_PRIMARY` | `#003366` | `#1e40af` |
| 강조/하이라이트 | `#e94560` | `COLOR_SEMANTIC_DANGER` | `#dc2626` | `#ef4444` |
...
| 카드 배경 | `#f8f9fa` | `COLOR_BG_CARD` | `#f8fafc` |
| 액센트 | `#2563eb` | `COLOR_BRAND_PRIMARY_BIZ` | `#2563eb` |
| 긍정 | `#10b981` | `COLOR_SEMANTIC_SUCCESS` | `#16a34a` |

### 2.3 v1 "마케팅/이벤트" 톤 → confex 오버레이 후보

| 영역 | v1 hex | JC 시맨틱 토큰 | confex 오버레이 hex |
|---|---|---|---|
| 액센트 1 | `#6366f1` | `COLOR_BRAND_PRIMARY` | `#6366f1` |
| 액센트 2 | `#f59e0b` | `COLOR_BRAND_ACCENT` | `#f59e0b` |
| 액센트 3 | `#ec4899` | `COLOR_BRAND_HIGHLIGHT` | `#ec4899` |

### 2.4 v1 "재무/회계" 톤 → 보수적 라이트 변형

| 영역 | v1 hex | JC 시맨틱 토큰 | 유니버설 hex |
|---|---|---|---|
| 액센트 | `#1e3a5f` | `COLOR_BRAND_PRIMARY_FINANCE` | `#1e3a5f` |
| 긍정 | `#2d7d46` | `COLOR_SEMANTIC_SUCCESS_SUBDUED` | `#2d7d46` |
...
|---|---|---|---|
| series-1 | `COLOR_CHART_SERIES_1` | `#2563eb` | `#3b82f6` |
| series-2 | `COLOR_CHART_SERIES_2` | `#7c3aed` | `#8b5cf6` |
| series-3 | `COLOR_CHART_SERIES_3` | `#0891b2` | `#06b6d4` |
| series-4 | `COLOR_CHART_SERIES_4` | `#d97706` | `#f59e0b` |
| series-5 | `COLOR_CHART_SERIES_5` | `#db2777` | `#ec4899` |
| series-6 | `COLOR_CHART_SERIES_6` | `#059669` | `#10b981` |
...
const primary = getToken('COLOR_BRAND_PRIMARY');   // → '#003366'

setOverlay('remember');                            // 리멤버 클라이언트
const primary = getToken('COLOR_BRAND_PRIMARY');   // → '#FF6D01'
```
